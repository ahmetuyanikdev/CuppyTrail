...
public class StadiumsController
{
	...
	@RequestMapping(value = "/stadiums/type/{stadiumType}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/stadiums/type/{stadiumType}/json", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	public List<StadiumData> getStadiumsInJsonFormat(@PathVariable final String stadiumType)
	{
		logger.info("#-- getting Stadiums in Json Format");
		final List<StadiumData> stadiums = stadiumFacade.getStadiumsByType(stadiumType, "none");
		return stadiums;
	}
